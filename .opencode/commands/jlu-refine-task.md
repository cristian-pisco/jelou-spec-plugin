...
1. `jelou/workflows/refine-task.md` (project-local install)
2. `<HOME>/.config/opencode/jelou/workflows/refine-task.md` (global install fallback; resolve `<HOME>` to an absolute path first)
