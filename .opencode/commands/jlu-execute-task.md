...
1. `jelou/workflows/execute-task.md` (project-local install)
2. `<HOME>/.config/opencode/jelou/workflows/execute-task.md` (global install fallback; resolve `<HOME>` to an absolute path first)
