...
1. `jelou/workflows/rollback-phase.md` (project-local install)
2. `<HOME>/.config/opencode/jelou/workflows/rollback-phase.md` (global install fallback; resolve `<HOME>` to an absolute path first)
