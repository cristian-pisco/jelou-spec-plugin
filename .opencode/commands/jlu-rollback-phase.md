---
description: Rollback to last good phase
agent: build
---
Resolve workflow path in this order:
1. `<HOME>/.config/opencode/jelou/workflows/rollback-phase.md` (global install preferred; resolve `<HOME>` to an absolute path first)
