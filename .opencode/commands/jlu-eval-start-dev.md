---
description: Audit whether /jlu-start-dev would boot a given task correctly, with an optional live proof
agent: build
---
...
1. `<install-root>/jelou/workflows/eval-start-dev.md` (install preferred)
