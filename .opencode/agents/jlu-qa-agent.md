...
- Verify each test fails when its asserted production behavior is removed or inverted; otherwise report it as tautological.

#### 3. Prohibited Diff Patterns
- Check for hardcoded values that should be configurable
- Check for missing error handling on new code paths
- Check for console.log/print statements when CONVENTIONS.md requires a logging facility
...
|----|------|----------|----------|----------|------------|
| QA-1 | `<requirement or documented rule>` | `src/file.ts:42` | HIGH/MEDIUM/LOW | `<observed violation>` | `<specific change>` |
...
#### 3. Edge Case & Coverage-Breadth Review
...
#### 7. Code Smells and Over-Engineering
