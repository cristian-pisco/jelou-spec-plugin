...
- **Attach evidence to every factual claim.** Cite an existing file and line or a user-confirmed answer; integrations cite the call site, conventions cite 2–3 occurrences, and concerns cite the triggering code or configuration.
- **Do not guess.** If neither code nor a recorded user answer supports a claim, omit it.
