---
description: "Use when resuming work in a fresh session — loads task context so you can pick up where you left off."
...
- Do not read or execute `skills/load-context/SKILL.md`; `skills/*/SKILL.md` files are Claude Code entry points, not Codex prompts.
