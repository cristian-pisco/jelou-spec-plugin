---
description: "Use to share sprint progress on Slack — generates and posts a sprint-scoped daily summary to a channel."
...
- Do not read or execute `skills/daily-slack/SKILL.md`; `skills/*/SKILL.md` files are Claude Code entry points, not Codex prompts.
