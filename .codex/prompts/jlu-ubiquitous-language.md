---
description: "Use to curate the workspace's domain glossary."
...
- Do not read or execute `skills/ubiquitous-language/SKILL.md`; `skills/*/SKILL.md` files are Claude Code entry points, not Codex prompts.
