---
description: "Use to see every local task created by /jlu-new-task — scans the workspace and prints a table of slug, title, lifecycle state, date, sprint, and affected services."
...
- Do not read or execute `skills/list-tasks/SKILL.md`; `skills/*/SKILL.md` files are Claude Code entry points, not Codex prompts.
