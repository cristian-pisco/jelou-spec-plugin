...
cp "$PLUGIN_DIR/bin/local-auth-onboarding.mjs" "$BIN_DIR/"
cp "$PLUGIN_DIR/bin/local-stack-e2e.mjs" "$BIN_DIR/"
cp "$PLUGIN_DIR/bin/local-test-data-cleanup.mjs" "$BIN_DIR/"
...
cp "$PLUGIN_DIR/bin/boot-stack.mjs" "$BIN_DIR/"
cp "$PLUGIN_DIR/bin/reconcile-stack-run.mjs" "$BIN_DIR/"
cp "$PLUGIN_DIR/bin/build-dispatch-prompt.mjs" "$BIN_DIR/"
cp "$PLUGIN_DIR/bin/classify-e2e-target.mjs" "$BIN_DIR/"
cp "$PLUGIN_DIR/bin/classify-task-scope.mjs" "$BIN_DIR/"
cp "$PLUGIN_DIR/bin/classify-phase.sh" "$BIN_DIR/"
cp "$PLUGIN_DIR/bin/classify-ignored-suite.mjs" "$BIN_DIR/"
...
cp "$PLUGIN_DIR/bin/e2e-app-mount-probe.mjs" "$BIN_DIR/"
cp "$PLUGIN_DIR/bin/e2e-session-sync.mjs" "$BIN_DIR/"
cp "$PLUGIN_DIR/bin/extract-doc-sections.mjs" "$BIN_DIR/"
cp "$PLUGIN_DIR/bin/extract-trace.mjs" "$BIN_DIR/"
cp "$PLUGIN_DIR/bin/finalize-phase.sh" "$BIN_DIR/"
cp "$PLUGIN_DIR/bin/format-changed-files.sh" "$BIN_DIR/"
cp "$PLUGIN_DIR/bin/parse-goal-matrix.mjs" "$BIN_DIR/"
cp "$PLUGIN_DIR/bin/phase-state.mjs" "$BIN_DIR/"
cp "$PLUGIN_DIR/bin/phase-open.mjs" "$BIN_DIR/"
cp "$PLUGIN_DIR/bin/phase-close.mjs" "$BIN_DIR/"
cp "$PLUGIN_DIR/bin/task-setup.mjs" "$BIN_DIR/"
cp "$PLUGIN_DIR/bin/probe-coverage-breadth.mjs" "$BIN_DIR/"
cp "$PLUGIN_DIR/bin/resolve-affected-tests.mjs" "$BIN_DIR/"
...
cp "$PLUGIN_DIR/bin/daily-slack-format-meetings.mjs" "$BIN_DIR/"
cp "$PLUGIN_DIR/bin/daily-slack-meetings-window.mjs" "$BIN_DIR/"
...
chmod +x "$BIN_DIR/classify-phase.sh" "$BIN_DIR/finalize-phase.sh" "$BIN_DIR/format-changed-files.sh"
...
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/events.mjs" "$BIN_DIR/lib/dev-orchestrator/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/state.mjs" "$BIN_DIR/lib/dev-orchestrator/"
...
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stack/resolve-compose-mounts.mjs" "$BIN_DIR/lib/dev-orchestrator/stack/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stack/resolve-network-alias.mjs" "$BIN_DIR/lib/dev-orchestrator/stack/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stack/wiring.mjs" "$BIN_DIR/lib/dev-orchestrator/stack/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stack/frontend-env.mjs" "$BIN_DIR/lib/dev-orchestrator/stack/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stack/e2e-env.mjs" "$BIN_DIR/lib/dev-orchestrator/stack/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stack/stack-state.mjs" "$BIN_DIR/lib/dev-orchestrator/stack/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stack/auth-cookie-state.mjs" "$BIN_DIR/lib/dev-orchestrator/stack/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stack/auth-runtime.mjs" "$BIN_DIR/lib/dev-orchestrator/stack/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stack/auth-session.mjs" "$BIN_DIR/lib/dev-orchestrator/stack/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stack/auth-urls.mjs" "$BIN_DIR/lib/dev-orchestrator/stack/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stack/login-cookie.mjs" "$BIN_DIR/lib/dev-orchestrator/stack/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stack/local-onboarding.mjs" "$BIN_DIR/lib/dev-orchestrator/stack/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stack/local-keyring.mjs" "$BIN_DIR/lib/dev-orchestrator/stack/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stack/local-target.mjs" "$BIN_DIR/lib/dev-orchestrator/stack/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stack/local-provisioning.mjs" "$BIN_DIR/lib/dev-orchestrator/stack/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stack/local-jelou-provisioning-adapter.mjs" "$BIN_DIR/lib/dev-orchestrator/stack/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stack/local-stack-e2e-config.mjs" "$BIN_DIR/lib/dev-orchestrator/stack/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stack/local-stack-e2e-adapter.mjs" "$BIN_DIR/lib/dev-orchestrator/stack/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stack/local-stack-driver.mjs" "$BIN_DIR/lib/dev-orchestrator/stack/"
cp "$PLUGIN_DIR/bin/lib/boot-engine/host-map.mjs" "$BIN_DIR/lib/boot-engine/"
cp "$PLUGIN_DIR/bin/rewrite-e2e-env.mjs" "$BIN_DIR/"
...
cp "$PLUGIN_DIR/bin/lib/registry/package-manager.mjs" "$BIN_DIR/lib/registry/"
cp "$PLUGIN_DIR/bin/lib/registry/validate-dev-commands.mjs" "$BIN_DIR/lib/registry/"
cp "$PLUGIN_DIR/bin/lib/registry/merge-dev-blocks.mjs" "$BIN_DIR/lib/registry/"
cp "$PLUGIN_DIR/bin/lib/registry/id-divergence.mjs" "$BIN_DIR/lib/registry/"
cp "$PLUGIN_DIR/bin/lib/boot-engine/execute-shared-reuse.mjs" "$BIN_DIR/lib/boot-engine/"
cp "$PLUGIN_DIR/bin/lib/boot-engine/boot-plan-runner.mjs" "$BIN_DIR/lib/boot-engine/"
cp "$PLUGIN_DIR/bin/lib/boot-engine/execute.mjs" "$BIN_DIR/lib/boot-engine/"
cp "$PLUGIN_DIR/bin/lib/boot-engine/env-mask.mjs" "$BIN_DIR/lib/boot-engine/"
cp "$PLUGIN_DIR/bin/lib/boot-engine/deps-provision.mjs" "$BIN_DIR/lib/boot-engine/"
cp "$PLUGIN_DIR/bin/lib/boot-engine/launcher.mjs" "$BIN_DIR/lib/boot-engine/"
...
cp "$PLUGIN_DIR/bin/lib/app-mount.mjs" "$BIN_DIR/lib/"
...
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/task-context.mjs" "$BIN_DIR/lib/dev-orchestrator/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/task-source.mjs" "$BIN_DIR/lib/dev-orchestrator/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/source-mode.mjs" "$BIN_DIR/lib/dev-orchestrator/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/add.mjs" "$BIN_DIR/lib/dev-orchestrator/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/daemon.mjs" "$BIN_DIR/lib/dev-orchestrator/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/daemon-spawn.mjs" "$BIN_DIR/lib/dev-orchestrator/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/patterns-matcher.mjs" "$BIN_DIR/lib/dev-orchestrator/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/start.mjs" "$BIN_DIR/lib/dev-orchestrator/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stop.mjs" "$BIN_DIR/lib/dev-orchestrator/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/state-daemon.mjs" "$BIN_DIR/lib/dev-orchestrator/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/tmux.mjs" "$BIN_DIR/lib/dev-orchestrator/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stack/compose-down.mjs" "$BIN_DIR/lib/dev-orchestrator/stack/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stack/stack-teardown.mjs" "$BIN_DIR/lib/dev-orchestrator/stack/"
cp "$PLUGIN_DIR/bin/lib/dev-orchestrator/stack/teardown-plan.mjs" "$BIN_DIR/lib/dev-orchestrator/stack/"
