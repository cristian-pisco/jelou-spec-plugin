...
echo "  /jlu:refine-spec     — Refine a spec through interview"
echo "  /jlu:execute-task    — Run TDD implementation"
echo "  /jlu:extend-phase    — Extend an in-progress phase"
echo "  /jlu:sync-clickup    — Sync with ClickUp"
echo "  /jlu:publish-uh      — Publish user stories to ClickUp"
...
echo "  /jlu:setup-clickup   — Configure ClickUp integration"
echo "  /jlu:new-project     — Bootstrap a new project"
