---
name: update
description: Use to update the Jelou Spec Plugin to the latest version from any runtime — pulls the shared git cache and reinstalls. Fills the gap for Codex and OpenCode, which have no built-in plugin update. Triggers: "update the plugin", "update jlu", "upgrade jelou plugin", "actualizar el plugin", "actualiza jlu", "get the latest version of the plugin"
