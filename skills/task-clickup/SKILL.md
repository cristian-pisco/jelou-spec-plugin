...
1. Go up 2 levels from this skill's directory (plugin install at `<plugin-root>/skills/task-clickup/SKILL.md`).
...
2. `Read`: `<plugin-root>/jelou/workflows/task-clickup.md`
