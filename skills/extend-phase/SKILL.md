...
1. Go up 2 levels from this skill's directory (plugin install at `<plugin-root>/skills/extend-phase/SKILL.md`).
...
2. `Read`: `<plugin-root>/jelou/workflows/extend-phase.md`
